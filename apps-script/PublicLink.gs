...
function getCabinGuideSteps(cabin, tipo, checkoutExtendido, horaSalidaCustom) {
  ...
  // La basura NO se la llevan: la recoge el personal. Decía lo contrario en las
  // tres cabañas, en el menú del día de salida y en la guía del sitio público.
  const checkoutBody  = 'Dejar la cocina limpia · La basura se queda, el personal la recoge · Llave y control dentro del key box.';
  ...
  const steps = {
    ...
    azul: [
      ['&#128273;', 'Acceso', 'Key Box código <strong>0507</strong>. Dentro está la llave de la cabaña y, en el mismo llavero, un control negro con botones verdes que abre el portón verde de la entrada. Úsenlo si necesitan salir <strong>durante su estadía</strong>.<br><strong>El día del check-out el control se queda</strong>: déjenlo en el key box junto con la llave.'],
      // Va en su propio paso: es lo primero que necesitan, parados frente a la
      // puerta con la llave en la mano. Estaba al final del párrafo de Acceso,
      // DESPUÉS de la instrucción de check-out.
